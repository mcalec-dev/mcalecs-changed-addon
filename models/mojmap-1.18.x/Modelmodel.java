	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Bottom_r1 = LeftEar.addOrReplaceChild("Bottom_r1",
				CubeListBuilder.create().texOffs(36, 5)
						.addBox(2.0F, -33.0F, -14.5F, 1.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(38, 0)
						.addBox(2.0F, -33.75F, -14.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Bottom_r2 = RightEar.addOrReplaceChild("Bottom_r2",
				CubeListBuilder.create().texOffs(48, 5)
						.addBox(-3.0F, -33.0F, -14.5F, 1.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(48, 0)
						.addBox(-3.0F, -33.75F, -14.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, -0.6545F, 0.0F));

		PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create().texOffs(0, 20).addBox(
				-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 0.0F));

		PartDefinition Tail = Torso.addOrReplaceChild("Tail", CubeListBuilder.create(),
				PartPose.offset(0.0F, 11.0F, 0.0F));

		PartDefinition Tip_r1 = Tail
				.addOrReplaceChild("Tip_r1",
						CubeListBuilder.create().texOffs(28, 27).addBox(-1.5F, 0.25F, -1.5F, 3.0F, 6.0F, 3.0F,
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 40)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(58, 65)
				.addBox(-1.75F, 11.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 11.0F, 0.0F));

		PartDefinition Lower_r1 = LeftLeg.addOrReplaceChild("Lower_r1",
		...
		PartDefinition Middle_r1 = LeftLeg.addOrReplaceChild("Middle_r1",
		...
		PartDefinition Upper_r1 = LeftLeg.addOrReplaceChild("Upper_r1",
		...
		PartDefinition LeftUpperToes = LeftToes.addOrReplaceChild("LeftUpperToes", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Toe3_r1 = LeftUpperToes.addOrReplaceChild("Toe3_r1",
				CubeListBuilder.create().texOffs(20, 37)
						.addBox(3.25F, 0.05F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 37)
						.addBox(1.75F, 0.05F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 37)
						.addBox(0.25F, 0.05F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6109F, 0.0F, 0.0F));

		PartDefinition LeftLowerToes = LeftToes.addOrReplaceChild("LeftLowerToes", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Toe3_r2 = LeftLowerToes.addOrReplaceChild("Toe3_r2",
				CubeListBuilder.create().texOffs(20, 37)
						.addBox(3.25F, -1.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 37)
						.addBox(1.75F, -1.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 37)
						.addBox(0.25F, -1.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(58, 65)
				.addBox(-2.0F, 11.0F, -2.75F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.25F, 11.0F, 0.0F));

		PartDefinition Lower_r2 = RightLeg.addOrReplaceChild("Lower_r2",
		...
		PartDefinition Middle_r2 = RightLeg.addOrReplaceChild("Middle_r2",
		...
		PartDefinition Upper_r2 = RightLeg.addOrReplaceChild("Upper_r2",
		...
		PartDefinition RightUpperToes = RightToes.addOrReplaceChild("RightUpperToes", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Toe3_r3 = RightUpperToes.addOrReplaceChild("Toe3_r3",
				CubeListBuilder.create().texOffs(12, 37)
						.addBox(-1.25F, 0.05F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 37)
						.addBox(-2.75F, 0.05F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 37)
						.addBox(-4.25F, 0.05F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6109F, 0.0F, 0.0F));

		PartDefinition RightLowerToes = RightToes.addOrReplaceChild("RightLowerToes", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightLowerToe3_r1 = RightLowerToes.addOrReplaceChild("RightLowerToe3_r1",
				CubeListBuilder.create().texOffs(12, 37)
						.addBox(-1.25F, -1.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 37)
						.addBox(-2.75F, -1.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 37)
						.addBox(-4.25F, -1.0F, -3.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));
