...
public class AddonBookGUIButtonMessage {
	private final int buttonID, x, y, z;

	public AddonBookGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public AddonBookGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(AddonBookGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(AddonBookGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = AddonBookGUIMenu.guistate;
